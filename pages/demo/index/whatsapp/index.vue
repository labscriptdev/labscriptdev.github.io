<template>
  ...
  >
    ...
    <div class="mt-5 d-flex align-center" style="gap:15px;" v-if="numberLink">
...
<script>
  ...
  export default {
    ...
    computed: {
      numberLink() {
        const dial_code = this.params.dial_code;
        const number = this.params.number.replace(/[^0-9]/g, '');
        const text = this.params.text;

        const paramText = (number && text) ? `?text=${text}` : '';
        return number? `https://wa.me/${dial_code}${number}${paramText}`: false;
      },
    },
    data() {
      return {
        ...
        phoneCodes: [
          ...
          {"name": "Bolivia, Plurinational State of", "dial_code": "+591", "code": "BO", "emoji": "🇧🇴"},
          {"name": "Bosnia and Herzegovina", "dial_code": "+387", "code": "BA", "emoji": "🇧🇦"},
          {"name": "Botswana", "dial_code": "+267", "code": "BW", "emoji": "🇧🇼"},
          {"name": "Brasil", "dial_code": "+55", "code": "BR", "emoji": "🇧🇷"},
          ...
          {"name": "Cocos (Keeling) Islands", "dial_code": "+61", "code": "CC", "emoji": "🇨🇨"},
          {"name": "Colombia", "dial_code": "+57", "code": "CO", "emoji": "🇨🇴"},
          {"name": "Comoros", "dial_code": "+269", "code": "KM", "emoji": "🇰🇲"},
          {"name": "Congo", "dial_code": "+242", "code": "CG", "emoji": "🇨🇬"},
          {"name": "Congo, The Democratic Republic of the Congo", "dial_code": "+243", "code": "CD", "emoji": "🇨🇩"},
          ...
          {"name": "Falkland Islands (Malvinas)", "dial_code": "+500", "code": "FK", "emoji": "🇫🇰"},
          ...
          {"name": "Holy See (Vatican City State)", "dial_code": "+379", "code": "VA", "emoji": "🇻🇦"},
          ...
          {"name": "Iran, Islamic Republic of Persian Gulf", "dial_code": "+98", "code": "IR", "emoji": "🇮🇷"},
          ...
          {"name": "Korea, Democratic People's Republic of Korea", "dial_code": "+850", "code": "KP", "emoji": "🇰🇵"},
          {"name": "Korea, Republic of South Korea", "dial_code": "+82", "code": "KR", "emoji": "🇰🇷"},
          ...
          {"name": "Libyan Arab Jamahiriya", "dial_code": "+218", "code": "LY", "emoji": "🇱🇾"},
          ...
          {"name": "Mauritius", "dial_code": "+230", "code": "🇲🇺", "emoji": "🇲🇷"},
          {"name": "Mayotte", "dial_code": "+262", "code": "YT", "emoji": "🇾🇹"},
          {"name": "Mexico", "dial_code": "+52", "code": "MX", "emoji": "🇲🇽"},
          {"name": "Micronesia, Federated States of Micronesia", "dial_code": "+691", "code": "FM", "emoji": "🇫🇲"},
          ...
          {"name": "Palestinian Territory, Occupied", "dial_code": "+970", "code": "PS", "emoji": "🇵🇸"},
          ...
          {"name": "Saint Helena, Ascension and Tristan Da Cunha", "dial_code": "+290", "code": "SH", "emoji": "🇸🇭"},
          ...
          {"name": "South Georgia and the South Sandwich Islands", "dial_code": "+500", "code": "GS", "emoji": "🇬🇸"},
          ...
          {"name": "Tanzania, United Republic of Tanzania", "dial_code": "+255", "code": "TZ", "emoji": "🇹🇿"},
          ...
          {"name": "Venezuela, Bolivarian Republic of Venezuela", "dial_code": "+58", "code": "VE", "emoji": "🇻🇪"},
          {"name": "Vietnam", "dial_code": "+84", "code": "VN", "emoji": "🇻🇳"},
          {"name": "Virgin Islands, British", "dial_code": "+1284", "code": "VG", "emoji": "🇻🇬"},
